...
import { createRecoveryAction, executeL1Action, executeL2Action, getRecoveryAction, getRecoveryActionWithScope, startRecoveryAction, updateRecoveryActionStatus, } from './store.js';
...
export async function approveRecoveryActionWorkflow(actionId, scope) {
...
export async function rejectLinkedRecoveryAction(actionId, actorId, comment, scope) {
...
export async function approveLinkedRecoveryAction(actionId, scope) {
    await requireScopedRecoveryAction(actionId, scope);
...
export async function executeApprovedRecoveryAction(actionId) {
...
async function requireScopedRecoveryAction(actionId, scope) {
