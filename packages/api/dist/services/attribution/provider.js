...
function summarizeConfidence(hypotheses) {
...
async function runMockProvider(input) {
    const hypotheses = [
        {
...
async function runLsclawProvider(input) {
...
export async function analyzeAttribution(input) {
